...
from api.views import BlogCategoryCreateView, PostMediafileCreateView, PostCommentCreateView, BlogCategoryAPIView, BlogCategoryDetailAPIView, FavoritePostsDetailViewSet, FavoritePostsViewSet, BlogViewSet, PostViewSet

urlpatterns = [
    path('blog_category', BlogCategoryCreateView.as_view()),
